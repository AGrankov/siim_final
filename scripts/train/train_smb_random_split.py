...
def main():
    ...
    parser.add_argument('-m', '--model_name', default='smp_ur34_1024_v1', help='name of trained model')
    ...
    parser.add_argument('-e', '--epochs', default=130, help='epochs count', type=int)
    ...
    ds_class = RawSegmentationDataset
