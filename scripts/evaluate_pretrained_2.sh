...
export OUTPUT_FILENAME="../submissions/final_2_sub.csv.gz"
...
python3 predicting/predict_segmentation.py -i $DATA_INPUT -ss $SAMPLE_SUBMISSION -st 0.8 -mft 250 -o $OUTPUT_FILENAME -uk True
